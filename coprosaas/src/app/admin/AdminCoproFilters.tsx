...
const FILTERS = [
  { key: 'essai',    label: 'en essai',    cls: 'bg-amber-50 text-amber-700 border-amber-200',    activeCls: 'bg-amber-200 text-amber-900 border-amber-400' },
  ...
  return (
    <div className="flex gap-2 text-xs flex-wrap items-center">
      ...
      <span className="text-gray-400 px-2 py-1">
        {counts.lots} lots importés · {counts.coproprietaires} copropriétaires rattachés
      </span>
    </div>
  );
}
